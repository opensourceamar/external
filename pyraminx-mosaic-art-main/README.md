...
Transition from RGB Euclidean distance to **CIEDE2000** in the **CIE Lab** color space. This modification ensures that color quantization accounts for human visual non-linearities, preserving the "soul" of the image within a 4-color limit.
